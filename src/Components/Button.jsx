...
const variantStyles = {
    solid: {
        ...
        gradient: "bg-gradient-to-r from-orange-500 to-pink-600 text-white hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white",
    },
    outline: {
        slate:
