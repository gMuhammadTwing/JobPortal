                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                "De-identification/Anonymization/masking of job seeker’s name (Name codification). This protects the job seeker’s identity and detribalizes the hiring process by masking tribal names. Job seekers’ actual names are replaced by Unique Identification Codes (UIC).",
                                ...
                                "Coursework uploads and showcasing tilt the recruiting process to competency-based hiring, increasing job seeker’s chances of landing a job.",
