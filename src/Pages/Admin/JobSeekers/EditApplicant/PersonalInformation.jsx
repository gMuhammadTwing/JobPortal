                                        ...
                                        <div className="flex flex-col sm:flex-row gap-6 items-center px-2">
                                            <div className="relative group">
                                                {imageLoader ? (
                                                    ...
                                                    <img
                                                        src={
                                                            data?.data[0]?.user_id?.user_image
                                                                ? `${app_vars?.domain?.fileURL}${data?.data[0]?.user_id?.user_image}`
                                                                : userLogo
                                                        }
                                                        alt="User Profile"
                                            ...
                                            <div className="text-center sm:text-left">
                                                <h4 className="font-semibold text-xl text-gray-800">{data?.data[0]?.user_id?.name}</h4>
                                                <p className="text-sm text-gray-600">
                                                    <span className="font-medium text-gray-700">Email:</span> {data?.data[0]?.user_id?.email}
                                                </p>
                                                <p className="text-sm text-gray-600">
