...
export default function Index() {
    ...
    const fetchData = async (page, name, email) => {
        setTableLoader(true)
        try {
            const response = await axiosInstance.get(`/api/admin_user_list?role_id=4&page=${page}&name=${name}&email=${email}`);
            if (response) {
                                                ...
                                                data?.data?.map((item, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="py-4 pl-4 pr-3 text-smsm:pl-6 flex">
                                                            ...
                                                            <Link to={"edit-agency/" + item?.id}><PencilIcon className="w-5 h-5 cursor-pointer text-blue-500" title="Edit" /></Link>
                                                        </td>
                                                    </tr>
                                                ))
                                            ) : (
