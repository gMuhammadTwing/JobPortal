...
const navigation = [
  ...
  { name: 'Employer', href: 'employer/profile', current: false },
    ...
    <>
      ...
      */}
      <div className="min-h-full">
        <Disclosure as="nav" className="fixed top-0 left-0 right-0 z-10 bg-white">
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'bg-orange-600 text-white' : 'text-black hover:bg-orange-500 hover:text-white',
          ...
          <DisclosurePanel className="md:hidden">
            ...
            <div className="border-t border-orange-600 pb-3 pt-4">
              ...
              <div className="mt-3 space-y-1 px-2">
                {userNavigation.map((item) => (
                  <DisclosureButton
                    ...
                    as="a"
                    href={item.href}
                    className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-orange-600 hover:text-white"
                  >
                    {item.name}
                  </DisclosureButton>
                ))}
        ...
        {/* <header className="fixed top-16 left-0 right-0 z-10 bg-white shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">Dashboard</h1>
          </div>
        </header> */}
